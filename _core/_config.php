<?php
    ...
    $TransferLetterTitle    = "Migraciones";              // Letter Title
    $TransferLetterMessage  = "Items from character migration"; // Letter Message

    $DEFAULT_LANGUAGE       = "es_ES";                          // Default WebPage Language
	$LanguajeEnable			= 0; 								// 0 -> Desactivado / 1 -> Activado
	...
	$captchaEnable          = 1;            // Activado (1) / Desactivado (0) Captcha
    ...
    $DBPassword         = "ascent";               // Your DB Password

    $SOAPUser           = "soap";          // SOAP USER
    $SOAPPassword       = "123soap456admin";          // SOAP USER PASSWORD
    $GMLevel            = "(5,225)";// GM LEVEL ACCESS AVAIBLE CHECK TRANSFERS. IN BRACKETS AND SEPARATE WITH COMMA. EXAMPLE: "(3,4)"
    ...
    function _SOAPHSwitch($RealmID) {       // Realm ID = Realm ID From Realmlist table
        ...
        $SOAPHost2  = "127.0.0.1";                   // Realm 2 SOAP HOST
        $SOAPHost3  = "127.0.0.1";                   // Realm 3 SOAP HOST
    ...
    function _SOAPPSwitch($RealmID) {       // Realm ID = Realm ID From Realmlist table
        ...
        $SOAPPort2  = 7878;                   // Realm 2 SOAP PORT
        $SOAPPort3  = 7879;                   // Realm 3 SOAP PORT
    ...
    function _HostDBSwitch($RealmID) {        // Realm ID = Realm ID From Realmlist table
        ...
        $HostDB2      = "127.0.0.1";                   // Realm 2 Host DB
        $HostDB3      = "127.0.0.1";                   // Realm 3 Host DB
    ...
    function _CharacterDBSwitch($RealmID) {         // Realm ID = Realm ID From Realmlist table
        ...
        $CharactersDB2      = "characters";                   // Realm 2 Character DB
        $CharactersDB3      = "characters2";                   // Realm 3 Character DB
    ...
    function _WorldDBSwitch($RealmID) {          // Realm ID = Realm ID From Realmlist table
        $WorldDB1      = "world";  // Realm 1 World DB
        $WorldDB2      = "world";                // Realm 2 World DB
        $WorldDB3      = "world2";                // Realm 3 World DB
